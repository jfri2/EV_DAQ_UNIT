...
#define HE_NC_MASK      ((1<<PORTC0) | (1<<PORTC1) | (1<<PORTC2))  // NC (no connect) pins
#define HE_NC_ADC_PIN   ((1<<ADC0D) | (1<<ADC1D) | (1<<ADC2D))     // NC pin ADC channels (used to disable digital input buffers)
